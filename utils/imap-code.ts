...
/**
 * Function to Open mail Inbox using Imap
 * @param imap 
 * @returns 
 */
...
/**
 * Function to check received mail using Imap Server
 * @returns - An object that consists the latest mail
 */
export async function verifyEmail(): Promise<EmailMessage | null> {
